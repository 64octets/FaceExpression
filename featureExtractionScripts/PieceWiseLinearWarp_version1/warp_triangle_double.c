        ...
        int nrhs, const mxArray *prhs[] )
{
    ...
    for(q=0; q<Tsize[0]; q++)
    {
        ...
        Lambdat[0]=g12[1]*boundmin[1]+c12;
        Lambdat[1]=g20[1]*boundmin[1]+c20;
        Lambdat[2]=g01[1]*boundmin[1]+c01;
        for(j=boundmin[1]; j<=boundmax[1]; j++)
        {
            Lambda[0] = Lambdat[0]+g12[0]*boundmin[0];
            Lambda[1] = Lambdat[1]+g20[0]*boundmin[0];
            Lambda[2] = Lambdat[2]+g01[0]*boundmin[0];
